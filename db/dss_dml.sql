...
INSERT INTO dss_homepage_demo_instance (id, menu_id, name, url, title_en, title_cn, description, is_active, icon, `order`, click_num, create_by, create_time, last_update_time, last_update_user) VALUES (1, 1, '工作流编辑执行', 'https://www.iteblog.com/', '工作流编辑执行EN', '工作流编辑执行', '工作流编辑执行', 1, null, 1, 0, null, null, null, null);
INSERT INTO dss_homepage_demo_instance (id, menu_id, name, url, title_en, title_cn, description, is_active, icon, `order`, click_num, create_by, create_time, last_update_time, last_update_user) VALUES (2, 1, '工作流串联可视化', 'https://www.iteblog.com', '工作流串联可视化EN', '工作流串联可视化', '工作流串联可视化', 1, null, 2, 0, null, null, null, null);
INSERT INTO dss_homepage_demo_instance (id, menu_id, name, url, title_en, title_cn, description, is_active, icon, `order`, click_num, create_by, create_time, last_update_time, last_update_user) VALUES (3, 1, '工作流调度执行跑批', 'https://www.iteblog.com', '工作流调度执行跑批EN', '工作流调度执行跑批', '工作流调度执行跑批', 1, null, 3, 0, null, null, null, null);
INSERT INTO dss_homepage_demo_instance (id, menu_id, name, url, title_en, title_cn, description, is_active, icon, `order`, click_num, create_by, create_time, last_update_time, last_update_user) VALUES (4, 2, '某业务日常运营报表', 'https://www.iteblog.com', '某业务日常运营报表EN', '某业务日常运营报表', '某业务日常运营报表', 1, null, 1, 0, null, null, null, null);
INSERT INTO dss_homepage_demo_instance (id, menu_id, name, url, title_en, title_cn, description, is_active, icon, `order`, click_num, create_by, create_time, last_update_time, last_update_user) VALUES (5, 2, '某业务机器学习建模预测', 'https://www.iteblog.com', '某业务机器学习建模预测EN', '某业务机器学习建模预测', '某业务机器学习建模预测', 1, null, 2, 0, null, null, null, null);
INSERT INTO dss_homepage_demo_instance (id, menu_id, name, url, title_en, title_cn, description, is_active, icon, `order`, click_num, create_by, create_time, last_update_time, last_update_user) VALUES (6, 2, '某业务导出营销用户列表', 'https://www.iteblog.com', '某业务导出营销用户列表EN', '某业务导出营销用户列表', '某业务导出营销用户列表', 1, null, 3, 0, null, null, null, null);
INSERT INTO dss_homepage_demo_instance (id, menu_id, name, url, title_en, title_cn, description, is_active, icon, `order`, click_num, create_by, create_time, last_update_time, last_update_user) VALUES (7, 3, '数据大屏体验', 'https://www.iteblog.com', '数据大屏体验EN', '数据大屏体验', '数据大屏体验', 1, null, 1, 0, null, null, null, null);
INSERT INTO dss_homepage_demo_instance (id, menu_id, name, url, title_en, title_cn, description, is_active, icon, `order`, click_num, create_by, create_time, last_update_time, last_update_user) VALUES (8, 3, '数据仪表盘体验', 'https://www.iteblog.com', '数据仪表盘体验', '数据仪表盘体验', '数据仪表盘体验', 1, null, 2, 0, null, null, null, null);
INSERT INTO dss_homepage_demo_instance (id, menu_id, name, url, title_en, title_cn, description, is_active, icon, `order`, click_num, create_by, create_time, last_update_time, last_update_user) VALUES (9, 3, '可视化挂件快速体验', 'https://www.iteblog.com', '可视化挂件快速体验EN', '可视化挂件快速体验', '可视化挂件快速体验', 1, null, 3, 0, null, null, null, null);