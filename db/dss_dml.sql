...
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (@workflow_node_sql,10);
...
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (@workflow_node_pyspark,10);
...
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (@workflow_node_scala,10);
...
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,@node_ui_title);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,@node_ui_desc);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,@node_ui_businessTag);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,@node_ui_appTag);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,@node_ui_category);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,@node_ui_subject);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,@node_ui_content);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,@node_ui_to);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,@node_ui_cc);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,@node_ui_bcc);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (9,@node_ui_title);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (9,@node_ui_desc);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (9,@node_ui_businessTag);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (9,@node_ui_appTag);
...
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (9,@node_ui_msg_sender);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (@workflow_node_connector,40);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (9,@node_ui_msg_body);
...
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (11,@node_ui_title);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (11,@node_ui_desc);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (11,@node_ui_businessTag);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (11,@node_ui_appTag);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (11,@node_ui_source_type);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (11,@node_ui_check_object);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (11,@node_ui_max_check_hours);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (11,@node_ui_job_desc);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (@workflow_node_subFlow,@node_ui_title);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (@workflow_node_subFlow,2);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (@workflow_node_subFlow,@node_ui_desc);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (@workflow_node_subFlow,4);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (@workflow_node_subFlow,@node_ui_businessTag);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (12,@node_ui_appTag);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (13,@node_ui_title);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (13,2);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (13,@node_ui_desc);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (13,4);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (13,@node_ui_businessTag);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (13,@node_ui_appTag);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (14,@node_ui_title);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (14,2);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (14,@node_ui_desc);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (14,4);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (14,@node_ui_businessTag);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (14,@node_ui_appTag);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (15,@node_ui_title);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (15,@node_ui_desc);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (15,@node_ui_businessTag);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (15,@node_ui_appTag);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (16,@node_ui_title);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (16,@node_ui_desc);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (16,@node_ui_businessTag);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (16,@node_ui_appTag);
...
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (17,@node_ui_title);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (17,@node_ui_desc);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (17,@node_ui_businessTag);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (17,@node_ui_appTag);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (17,@node_ui_bindViewKey);
...
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (18,@node_ui_title);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (18,@node_ui_desc);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (18,@node_ui_executeUser);
...
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (20,@node_ui_title);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (20,@node_ui_desc);
...
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (8,@node_ui_ReuseEngine);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (9,@node_ui_ReuseEngine);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (@workflow_node_connector,@node_ui_ReuseEngine);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (11,@node_ui_ReuseEngine);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (@workflow_node_subFlow,@node_ui_ReuseEngine);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (13,@node_ui_ReuseEngine);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (14,@node_ui_ReuseEngine);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (15,@node_ui_ReuseEngine);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (17,@node_ui_ReuseEngine);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (20,@node_ui_ReuseEngine);
