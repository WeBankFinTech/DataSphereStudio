...
insert  into `dss_sidebar`(`id`,`workspace_id`,`name`,`name_en`,`title`,`title_en`,`type`,`order_num`,`remark`,`create_user`,`create_time`,`update_user`,`update_time`) values (1,0,'知识库','Knowledge base','知识库','Knowledge base',0,1,NULL,'SYSTEM','2020-12-15 13:21:06',NULL,'2021-02-23 09:45:41');
...
insert  into `dss_sidebar_content`(`id`,`workspace_id`,`sidebar_id`,`name`,`name_en`,`title`,`title_en`,`url`,`url_type`,`icon`,`order_num`,`remark`,`create_user`,`create_time`,`update_user`,`update_time`) values (1,0,1,NULL,NULL,'部门队列申请','Department application','http://127.0.0.1:8088/kn/d/38',1,'wendang',1,NULL,'SYSTEM','2020-12-15 13:21:06',NULL,'2021-02-23 09:47:29');
insert  into `dss_sidebar_content`(`id`,`workspace_id`,`sidebar_id`,`name`,`name_en`,`title`,`title_en`,`url`,`url_type`,`icon`,`order_num`,`remark`,`create_user`,`create_time`,`update_user`,`update_time`) values (2,0,1,NULL,NULL,'部门导数申请','Departmental derivative','http://127.0.0.1:8088/kn/d/40',1,'wendang',1,NULL,'SYSTEM','2020-12-15 13:21:07',NULL,'2021-02-23 09:47:36');
...
INSERT INTO `dss_workspace_menu` (`id`, `name`, `title_en`, `title_cn`, `description`, `is_active`, `icon`, `order`, `create_by`, `create_time`, `last_update_time`, `last_update_user`) VALUES('1','应用开发','application development','应用开发','应用开发描述','1',NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO dss_workspace_menu_appconn (id, appconn_id, menu_id, title_en, title_cn, desc_en, desc_cn, labels_en, labels_cn, is_active, access_button_en, access_button_cn, manual_button_en, manual_button_cn, manual_button_url, icon, `order`, create_by, create_time, last_update_time, last_update_user, image) VALUES (4, 5, 5, 'Scriptis', '即席查询', 'Scriptis is a one-stop interactive data exploration analysis tool built by WeDataSphere, uses Linkis as the kernel.', 'Scriptis是微众银行微数域(WeDataSphere)打造的一站式交互式数据探索分析工具，以任意桥(Linkis)做为内核，提供多种计算存储引擎(如Spark、Hive、TiSpark等)、Hive数据库管理功能、资源(如Yarn资源、服务器资源)管理、应用管理和各种用户资源(如UDF、变量等)管理的能力。', 'scripts development,IDE', '脚本开发,IDE', 1, 'enter Scriptis', '进入Scriptis', 'user manual', '用户手册', 'http://127.0.0.1:8088/wiki/scriptis/manual/workspace_cn.html', 'shujukaifa-logo', null, null, null, null, null, 'shujukaifa-icon');
INSERT INTO dss_workspace_menu_appconn (id, appconn_id, menu_id, title_en, title_cn, desc_en, desc_cn, labels_en, labels_cn, is_active, access_button_en, access_button_cn, manual_button_en, manual_button_cn, manual_button_url, icon, `order`, create_by, create_time, last_update_time, last_update_user, image) VALUES (5, 16, 2, 'workflow', '工作流开发', '工作流开发', '工作流开发', null, null, 1, 'Enter workflow', '进入 工作流开发', null, null, null, null, null, null, null, null, null, null);
INSERT INTO dss_workspace_menu_appconn (id, appconn_id, menu_id, title_en, title_cn, desc_en, desc_cn, labels_en, labels_cn, is_active, access_button_en, access_button_cn, manual_button_en, manual_button_cn, manual_button_url, icon, `order`, create_by, create_time, last_update_time, last_update_user, image) VALUES (9, 1, 1, 'Exchangis', '数据交换', 'Exchangis is a lightweight, high scalability, data exchange platform, support for structured and unstructured data transmission between heterogeneous data sources.', 'Exchangis是一个轻量级的、高扩展性的数据交换平台，支持对结构化及无结构化的异构数据源之间的数据传输，在应用层上具有数据权限管控、节点服务高可用和多租户资源隔离等业务特性，而在数据层上又具有传输架构多样化、模块插件化和组件低耦合等架构特点。', 'user manual', '生产,运维', 1, 'enter Exchangis', '进入Exchangis', 'user manual', '用户手册', 'http://127.0.0.1:8088/wiki/scriptis/manual/workspace_cn.html', 'shujujiaohuan-logo', null, null, null, null, null, 'shujujiaohuan-icon');
INSERT INTO dss_workspace_menu_appconn (id, appconn_id, menu_id, title_en, title_cn, desc_en, desc_cn, labels_en, labels_cn, is_active, access_button_en, access_button_cn, manual_button_en, manual_button_cn, manual_button_url, icon, `order`, create_by, create_time, last_update_time, last_update_user, image) VALUES (12, 12, 2, 'dataService', '数据服务', '/dataService', '/dataService', null, null, 1, 'Enter dataService', '进入 数据服务', null, null, null, null, null, null, null, null, null, null);
INSERT INTO dss_workspace_menu_appconn (id, appconn_id, menu_id, title_en, title_cn, desc_en, desc_cn, labels_en, labels_cn, is_active, access_button_en, access_button_cn, manual_button_en, manual_button_cn, manual_button_url, icon, `order`, create_by, create_time, last_update_time, last_update_user, image) VALUES (13, 13, 3, 'SharpScheduler', '运维中心', 'SharpScheduler', 'SharpScheduler', null, null, 1, 'Enter SharpScheduler', '进入 SharpScheduler', null, null, null, null, null, null, null, null, null, null);
INSERT INTO dss_workspace_menu_appconn (id, appconn_id, menu_id, title_en, title_cn, desc_en, desc_cn, labels_en, labels_cn, is_active, access_button_en, access_button_cn, manual_button_en, manual_button_cn, manual_button_url, icon, `order`, create_by, create_time, last_update_time, last_update_user, image) VALUES (14, 14, 5, 'CtView', '天翼视屏', '天翼视屏', '天翼视屏', null, null, 1, 'Enter 天翼视屏', '进入 天翼视屏', null, null, null, null, null, null, null, null, null, null);
INSERT INTO dss_workspace_menu_appconn (id, appconn_id, menu_id, title_en, title_cn, desc_en, desc_cn, labels_en, labels_cn, is_active, access_button_en, access_button_cn, manual_button_en, manual_button_cn, manual_button_url, icon, `order`, create_by, create_time, last_update_time, last_update_user, image) VALUES (15, 15, 5, 'superset', '数据报表', 'data view', '数据可视化', null, null, 1, 'Enter sdg', '进入 数据报表', null, null, null, null, null, null, null, null, null, null);
INSERT INTO dss_workspace_menu_appconn (id, appconn_id, menu_id, title_en, title_cn, desc_en, desc_cn, labels_en, labels_cn, is_active, access_button_en, access_button_cn, manual_button_en, manual_button_cn, manual_button_url, icon, `order`, create_by, create_time, last_update_time, last_update_user, image) VALUES (17, 17, 1, 'nifi', '数据接入(敬请期待)', '(敬请期待)', '(敬请期待)', null, null, 1, 'Enter nifi', '进入 数据接入(敬请期待)', null, null, null, null, null, null, null, null, null, null);
INSERT INTO dss_workspace_menu_appconn (id, appconn_id, menu_id, title_en, title_cn, desc_en, desc_cn, labels_en, labels_cn, is_active, access_button_en, access_button_cn, manual_button_en, manual_button_cn, manual_button_url, icon, `order`, create_by, create_time, last_update_time, last_update_user, image) VALUES (18, 18, 2, 'MLP', '机器学习平台(敬请期待)', '(敬请期待)', '(敬请期待)', null, null, 1, 'Enter MLP', '进入 机器学习平台', null, null, null, null, null, null, null, null, null, null);
INSERT INTO dss_workspace_menu_appconn (id, appconn_id, menu_id, title_en, title_cn, desc_en, desc_cn, labels_en, labels_cn, is_active, access_button_en, access_button_cn, manual_button_en, manual_button_cn, manual_button_url, icon, `order`, create_by, create_time, last_update_time, last_update_user, image) VALUES (19, 19, 3, 'streamis', '实时计算中心(敬请期待)', '(敬请期待)', '(敬请期待)', null, null, 1, 'Enter streamis', '进入 实时计算中心(敬请期待)', null, null, null, null, null, null, null, null, null, null);
INSERT INTO dss_workspace_menu_appconn (id, appconn_id, menu_id, title_en, title_cn, desc_en, desc_cn, labels_en, labels_cn, is_active, access_button_en, access_button_cn, manual_button_en, manual_button_cn, manual_button_url, icon, `order`, create_by, create_time, last_update_time, last_update_user, image) VALUES (20, 22, 4, 'dataGovernance', '数据治理', 'dataGovernance', 'dataGovernance', null, null, 1, 'Enter dataGovernance', '进入 数据治理', null, null, null, null, null, null, null, null, null, null);
INSERT INTO dss_workspace_menu_appconn (id, appconn_id, menu_id, title_en, title_cn, desc_en, desc_cn, labels_en, labels_cn, is_active, access_button_en, access_button_cn, manual_button_en, manual_button_cn, manual_button_url, icon, `order`, create_by, create_time, last_update_time, last_update_user, image) VALUES (21, 21, 4, 'dataSecurity', '数据安全(敬请期待)', '(敬请期待)', '(敬请期待)', null, null, 1, 'Enter dataSecurity', '进入 数据安全(敬请期待)', null, null, null, null, null, null, null, null, null, null);
...
insert into `dss_workflow_node` (`id`, `name`, `appconn_name`, `node_type`, `jump_type`, `support_jump`, `submit_to_scheduler`, `enable_copy`, `should_creation_before_node`, `icon`) values('1','python','-1','linkis.python.python','2','1','1','1','0','icons/python.icon');
insert into `dss_workflow_node` (`id`, `name`, `appconn_name`, `node_type`, `jump_type`, `support_jump`, `submit_to_scheduler`, `enable_copy`, `should_creation_before_node`, `icon`) values('2','pyspark','-1','linkis.spark.py','2','1','1','1','0','icons/pyspark.icon');
insert into `dss_workflow_node` (`id`, `name`, `appconn_name`, `node_type`, `jump_type`, `support_jump`, `submit_to_scheduler`, `enable_copy`, `should_creation_before_node`, `icon`) values('3','sql','-1','linkis.spark.sql','2','1','1','1','0','icons/sql.icon');
insert into `dss_workflow_node` (`id`, `name`, `appconn_name`, `node_type`, `jump_type`, `support_jump`, `submit_to_scheduler`, `enable_copy`, `should_creation_before_node`, `icon`) values('4','scala','-1','linkis.spark.scala','2','1','1','1','0','icons/scala.icon');
insert into `dss_workflow_node` (`id`, `name`, `appconn_name`, `node_type`, `jump_type`, `support_jump`, `submit_to_scheduler`, `enable_copy`, `should_creation_before_node`, `icon`) values('5','hql','-1','linkis.hive.hql','2','1','1','1','0','icons/hql.icon');
insert into `dss_workflow_node` (`id`, `name`, `appconn_name`, `node_type`, `jump_type`, `support_jump`, `submit_to_scheduler`, `enable_copy`, `should_creation_before_node`, `icon`) values('6','jdbc','-1','linkis.jdbc.jdbc','2','1','1','1','0','icons/jdbc.icon');
insert into `dss_workflow_node` (`id`, `name`, `appconn_name`, `node_type`, `jump_type`, `support_jump`, `submit_to_scheduler`, `enable_copy`, `should_creation_before_node`, `icon`) values('7','connector','-1','linkis.control.empty',NULL,'0','1','1','0','icons/connector.icon');
insert into `dss_workflow_node` (`id`, `name`, `appconn_name`, `node_type`, `jump_type`, `support_jump`, `submit_to_scheduler`, `enable_copy`, `should_creation_before_node`, `icon`) values('8','sendemail','-1','linkis.appconn.sendemail',NULL,'0','1','1','0','icons/sendemail.icon');
insert into `dss_workflow_node` (`id`, `name`, `appconn_name`, `node_type`, `jump_type`, `support_jump`, `submit_to_scheduler`, `enable_copy`, `should_creation_before_node`, `icon`) values('9','eventsender','-1','linkis.appconn.eventchecker.eventsender',NULL,'0','1','1','0','icons/eventsender.icon');
insert into `dss_workflow_node` (`id`, `name`, `appconn_name`, `node_type`, `jump_type`, `support_jump`, `submit_to_scheduler`, `enable_copy`, `should_creation_before_node`, `icon`) values('10','eventreceiver','-1','linkis.appconn.eventchecker.eventreceiver',NULL,'0','1','1','0','icons/eventreceiver.icon');
insert into `dss_workflow_node` (`id`, `name`, `appconn_name`, `node_type`, `jump_type`, `support_jump`, `submit_to_scheduler`, `enable_copy`, `should_creation_before_node`, `icon`) values('11','datachecker','-1','linkis.appconn.datachecker',NULL,'0','1','1','0','icons/datachecker.icon');
insert into `dss_workflow_node` (`id`, `name`, `appconn_name`, `node_type`, `jump_type`, `support_jump`, `submit_to_scheduler`, `enable_copy`, `should_creation_before_node`, `icon`) values('12','subFlow','-1','workflow.subflow','2','1','1','0','1','icons/subFlow.icon');
insert into `dss_workflow_node` (`id`, `name`, `appconn_name`, `node_type`, `jump_type`, `support_jump`, `submit_to_scheduler`, `enable_copy`, `should_creation_before_node`, `icon`) values('15','shell','-1','linkis.shell.sh','2','1','1','1','0','icons/shell.icon');
...
insert  into `dss_workflow_node_to_group`(`node_id`,`group_id`) values (1,2);
insert  into `dss_workflow_node_to_group`(`node_id`,`group_id`) values (2,2);
insert  into `dss_workflow_node_to_group`(`node_id`,`group_id`) values (3,2);
insert  into `dss_workflow_node_to_group`(`node_id`,`group_id`) values (4,2);
insert  into `dss_workflow_node_to_group`(`node_id`,`group_id`) values (5,2);
insert  into `dss_workflow_node_to_group`(`node_id`,`group_id`) values (6,2);
insert  into `dss_workflow_node_to_group`(`node_id`,`group_id`) values (15,2);
insert  into `dss_workflow_node_to_group`(`node_id`,`group_id`) values (16,3);
insert  into `dss_workflow_node_to_group`(`node_id`,`group_id`) values (8,5);
insert  into `dss_workflow_node_to_group`(`node_id`,`group_id`) values (9,6);
insert  into `dss_workflow_node_to_group`(`node_id`,`group_id`) values (10,6);
insert  into `dss_workflow_node_to_group`(`node_id`,`group_id`) values (11,6);
insert  into `dss_workflow_node_to_group`(`node_id`,`group_id`) values (12,7);
insert  into `dss_workflow_node_to_group`(`node_id`,`group_id`) values (7,7);
insert  into `dss_workflow_node_to_group`(`node_id`,`group_id`) values (18,3);
insert  into `dss_workflow_node_to_group`(`node_id`,`group_id`) values (19,3);
insert  into `dss_workflow_node_to_group`(`node_id`,`group_id`) values (20,8);

DELETE FROM dss_workflow_node_to_ui;
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (3,1);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (3,3);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (3,5);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (3,6);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (3,7);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (3,8);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (3,9);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (3,10);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (3,11);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (3,12);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (1,1);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (1,3);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (1,5);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (1,6);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (2,1);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (2,3);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (2,5);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (2,6);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (2,7);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (2,8);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (2,9);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (2,10);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (2,11);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (2,12);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (4,1);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (4,3);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (4,5);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (4,6);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (4,7);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (4,8);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (4,9);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (4,10);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (4,11);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (5,1);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (5,3);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (5,5);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (5,6);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (5,11);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (7,1);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (7,3);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (7,5);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (7,6);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,1);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,3);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,5);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,6);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,13);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,14);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,15);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,16);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,17);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (8,18);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (9,1);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (9,3);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (9,5);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (9,6);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (9,20);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (10,39);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (9,22);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (10,40);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (9,24);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (10,1);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (10,3);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (10,5);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (10,6);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (9,21);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (9,23);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (10,25);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (10,26);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (10,27);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (10,28);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (10,29);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (10,30);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (11,1);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (11,3);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (11,5);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (11,6);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (11,31);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (11,32);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (11,33);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (11,34);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (12,1);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (12,2);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (12,3);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (12,4);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (12,5);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (12,6);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (13,1);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (13,2);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (13,3);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (13,4);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (13,5);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (13,6);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (14,1);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (14,2);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (14,3);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (14,4);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (14,5);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (14,6);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (15,1);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (15,3);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (15,5);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (15,6);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (16,1);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (16,3);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (16,5);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (16,6);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (16,35);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (16,36);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (17,1);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (17,3);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (17,5);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (17,6);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (17,37);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (17,2);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (17,4);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (18,1);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (18,3);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (18,41);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (18,42);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (20,43);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (20,44);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (20,1);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (20,3);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (20,2);
insert  into `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) values (20,4);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (1,45);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (2,45);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (3,45);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (4,45);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (5,45);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (6,45);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (7,45);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (8,45);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (9,45);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (10,45);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (11,45);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (12,45);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (13,45);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (14,45);
INSERT  INTO `dss_workflow_node_to_ui`(`workflow_node_id`,`ui_id`) VALUES (15,45);
...
insert  into `dss_workflow_node_ui`(`id`,`key`,`description`,`description_en`,`lable_name`,`lable_name_en`,`ui_type`,`required`,`value`,`default_value`,`is_hidden`,`condition`,`is_advanced`,`order`,`node_menu_type`,`is_base_info`,`position`) values (4,'desc','请填写节点描述','Please enter the node description','节点描述','Node description','Text',0,NULL,NULL,0,NULL,0,2,0,1,'node');
...
insert  into `dss_workflow_node_ui`(`id`,`key`,`description`,`description_en`,`lable_name`,`lable_name_en`,`ui_type`,`required`,`value`,`default_value`,`is_hidden`,`condition`,`is_advanced`,`order`,`node_menu_type`,`is_base_info`,`position`) values (36,'executeUser','必填','Required','执行用户','Executor','Input',1,NULL,NULL,0,NULL,0,1,1,0,'runtime');
...
insert  into `dss_workflow_node_ui`(`id`,`key`,`description`,`description_en`,`lable_name`,`lable_name_en`,`ui_type`,`required`,`value`,`default_value`,`is_hidden`,`condition`,`is_advanced`,`order`,`node_menu_type`,`is_base_info`,`position`) values (43,'executeUser','请填写执行用户','Please enter execute user','执行用户','executeUser','Input',1,NULL,NULL,0,NULL,0,1,1,0,'runtime');
insert  into `dss_workflow_node_ui`(`id`,`key`,`description`,`description_en`,`lable_name`,`lable_name_en`,`ui_type`,`required`,`value`,`default_value`,`is_hidden`,`condition`,`is_advanced`,`order`,`node_menu_type`,`is_base_info`,`position`) values (44,'Filter','请填写过滤条件','Please enter filter','过滤条件','Filter','Input',0,NULL,NULL,0,NULL,0,1,1,0,'runtime');
...
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (31,31);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (32,32);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (32,40);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (32,41);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (28,28);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (27,27);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (3,32);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (3,41);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (4,32);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (4,41);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (22,44);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (22,45);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (22,41);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (25,25);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (26,32);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (26,41);
...
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (29,32);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (29,41);
...
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (24,32);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (24,41);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (7,7);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (8,8);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (9,9);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (10,10);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (11,41);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (11,57);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (1,48);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (1,47);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (2,48);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (2,47);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (13,13);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (14,47);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (16,50);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (17,50);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (18,50);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (19,51);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (19,47);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (5,52);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (6,52);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (12,52);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (20,53);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (36,52);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (30,52);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (33,54);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (34,32);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (35,52);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (31,55);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (32,55);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (34,41);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (22,55);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (20,55);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (26,55);
...
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (1,56);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (2,56);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (13,55);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (16,55);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (19,55);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (36,55);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (14,55);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (37,55);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (1,55);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (2,55);
...
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (15,55);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (22,58);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (26,58);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (41,55);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (43,55);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (44,52);
insert  into `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) values (42,52);
INSERT  INTO `dss_workflow_node_ui_to_validate`(`ui_id`,`validate_id`) VALUES (45,59);
