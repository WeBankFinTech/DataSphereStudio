...
-- ----------------------------
-- Table structure for linkis_oneservice_config
-- ----------------------------
DROP TABLE IF EXISTS `linkis_oneservice_config`;
CREATE TABLE `linkis_oneservice_config` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_linkis_oneservice_config_name` (`name`),
  UNIQUE KEY `uniq_linkis_oneservice_config_path` (`path`),
  UNIQUE KEY `uniq_linkis_oneservice_config_script_path` (`script_path`),
  KEY `idx_linkis_oneservice_config_script_path` (`script_path`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT='服务api配置表';

-- ----------------------------
-- Table structure for linkis_oneservice_param
-- ----------------------------
DROP TABLE IF EXISTS `linkis_oneservice_param`;
CREATE TABLE `linkis_oneservice_param` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_linkis_oneservice_param_config_id_version` (`config_id`,`version`)
