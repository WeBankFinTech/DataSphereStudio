...
public class HttpUtils {
    ...
    public static Response httpClientHandleBase(
            String actionUrl, RequestBody requestBody, Map<String, String> urlMap)
            throws IOException {
        String maskUrl =
                actionUrl
                        + "appid="
                        ...
                        + urlMap.get("nonce")
                        + "&&timestamp="
                        + urlMap.get("timestamp")
                        + "&&signature="
                        + urlMap.get("signature");
    ...
    public static String httpClientHandle(
            String actionUrl, RequestBody requestBody, Map<String, String> urlMap)
            throws Exception {
        String returnData = "";
        try {
    ...
    public static Map<String, String> initSelectParams(Properties props) {
        ...
        requestProperties.put(
                "signature", getMD5(getMD5(appid + nonce.toString() + cur_time) + token));
