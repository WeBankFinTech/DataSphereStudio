...
public class DolphinSchedulerProjectCreationOperation
        implements ProjectCreationOperation, DolphinSchedulerConf {

    private static final Logger logger =
            LoggerFactory.getLogger(DolphinSchedulerProjectCreationOperation.class);
    ...
    public void init() {
        ...
        this.projectUrl =
                baseUrl.endsWith("/") ? baseUrl + "projects/create" : baseUrl + "/projects/create";
    ...
    public ProjectResponseRef createProject(ProjectRequestRef requestRef)
        ...
        DolphinSchedulerHttpPost httpPost =
                new DolphinSchedulerHttpPost(projectUrl, Constant.DS_ADMIN_USERNAME);
        ...
        try (CloseableHttpResponse httpResponse =
            ...
            throw new ExternalOperationFailedException(
                    90022, "failed to create project in DolphinScheduler", e);
        }
