...
public class DolphinSchedulerProjectUpdateOperation
        implements ProjectUpdateOperation, DolphinSchedulerConf {

    private static final Logger logger =
            LoggerFactory.getLogger(DolphinSchedulerProjectUpdateOperation.class);
    ...
    public void init() {
        ...
        this.projectUpdateUrl =
                baseUrl.endsWith("/") ? baseUrl + "projects/update" : baseUrl + "/projects/update";
    ...
    @Override
    public ProjectResponseRef updateProject(ProjectRequestRef requestRef)
            throws ExternalOperationFailedException {
        // Dolphin Scheduler项目名
        String dsProjectName =
                ProjectUtils.generateDolphinProjectName(
                        requestRef.getWorkspaceName(), requestRef.getName());
        ...
        DolphinSchedulerHttpPost httpPost =
                new DolphinSchedulerHttpPost(projectUpdateUrl, Constant.DS_ADMIN_USERNAME);
        ...
        try (CloseableHttpResponse httpResponse =
            ...
            if (HttpStatus.SC_OK == httpResponse.getStatusLine().getStatusCode()
                ...
                logger.info(
                        "DolphinScheduler更新项目 {} 成功, 返回的信息是 {}",
                        dsProjectName,
        ...
        DolphinSchedulerUserOperation userOperation =
                new DolphinSchedulerUserOperation(this.baseUrl);
        // 新增授权用户
        List<String> releaseUsersIncreased =
                (List<String>) requestRef.getParameter("releaseUsersIncreased");
        List<String> releaseUsersDecreased =
                (List<String>) requestRef.getParameter("releaseUsersDecreased");
        try {
