 ...
 * @date 2021/05/21
 */
public class DolphinSchedulerWorkflowService extends AbstractConversionService
        implements DSSToRelConversionService {

    private Map<Class<? extends Operation>, Operation<?, ?>> operationMap =
    ...
    public WorkflowToRelConversionOperation getDSSToRelConversionOperation() {
        return getOrCreate(
                DolphinSchedulerWorkflowUploadOperation::new,
                DolphinSchedulerWorkflowUploadOperation.class);
    }
