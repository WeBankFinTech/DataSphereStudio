...
public class Props {
    ...
    /**
     * Put the given Properties into the Props. This method performs any variable substitution in
     * the value replacing any occurrence of ${name} with the value of get("name"). get() is called
     * first on the Props and next on the Properties object.
     *
    ...
    /**
     * Attempts to return the Class that corresponds to the Props value. If the class doesn't exit,
    ...
    /**
     * Returns a list of clusters with the comma as the separator of the value e.g., for input
     * string: "thrift://hcat1:port,thrift://hcat2:port;thrift://hcat3:port,thrift://hcat4:port;" we
     * will get ["thrift://hcat1:port,thrift://hcat2:port",
     * "thrift://hcat3:port,thrift://hcat4:port"] as output
     */
    ...
    public List<String> getStringList(
            final String key, final List<String> defaultValue, final String sep) {
        if (containsKey(key)) {
    ...
    /**
     * Returns the double representation of the value. If the value is null, then the default value
     * is returned. If the value isn't a double, then a parse exception will be thrown.
     */
     ...
     * UndefinedPropertyException will be thrown. If the value isn't a double, then a parse
    ...
    /**
     * Returns the double representation of the value. If the value is null, then the default value
     * is returned. If the value isn't a uri, then a IllegalArgumentException will be thrown.
     */
    ...
    /**
     * Returns a java.util.Properties file populated with the current Properties in here. Note: if
     * you want to import parent properties (e.g., database credentials), please use toAllProperties
     */
     ...
     * alphabetically by the key value. @Return
     */
    ...
    public Map<String, String> getMapByPrefix(final String prefix) {
        final Map<String, String> values =
                this._parent == null ? new HashMap<>() : this._parent.getMapByPrefix(prefix);
