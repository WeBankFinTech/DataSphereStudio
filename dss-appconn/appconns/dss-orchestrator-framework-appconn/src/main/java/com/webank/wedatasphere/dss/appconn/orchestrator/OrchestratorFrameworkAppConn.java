...
public class OrchestratorFrameworkAppConn extends AbstractAppConn implements OnlyDevelopmentAppConn {

    public static final String APP_CONN_NAME = "orchestrator-framework";
