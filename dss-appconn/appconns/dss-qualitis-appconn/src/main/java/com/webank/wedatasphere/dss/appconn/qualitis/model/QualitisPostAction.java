...
public class QualitisPostAction extends POSTAction implements UserAction {

    private static final Logger LOGGER = LoggerFactory.getLogger(QualitisPostAction.class);
    String url;
    String user;
