...
public class QualitisProjectResponseRef extends AbstractResponseRef implements ProjectResponseRef {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(QualitisProjectResponseRef.class);
    private Long projectRefId;
    private AppInstance appInstance;
    private String errorMsg;

    protected QualitisProjectResponseRef(String responseBody, int status) throws Exception {
