...
public class QualitisOpenResponseRef extends CommonResponseRef {

    public QualitisOpenResponseRef(String responseBody, int status) {
        super(responseBody, status);
        responseMap = Maps.newHashMap();
        responseMap.put("jumpUrl", responseBody);
    }
