...
public class SchedulisScheduleInfoGetOperation{
    ...
    public String getSchedulerInfo(String username, String projectName, String flowName){
        try{
            ...
            String finalUrl = this.scheduleInfoUrl + "?" +
    ...
    public void setProjectAndFlowPriv(String projectOwner, String projectName, List<String> accessUsers) throws Exception{
        ...
        try {
            ...
            for (String accessUser : accessUsers) {
                ...
                LOGGER.info("for project {} add a user {} response is {} content is {}",
                        projectName, accessUser, response.getStatusLine().getStatusCode(), responseContent);
            }
        } finally {
