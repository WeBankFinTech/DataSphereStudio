...
public class VisualisExecutionService implements RefExecutionService {

    DevelopmentService developmentService;

    @Override
    public RefExecutionOperation createRefExecutionOperation() {
        VisualisRefExecutionOperation visualisRefExecutionOperation = new VisualisRefExecutionOperation(getDevelopmentService());
