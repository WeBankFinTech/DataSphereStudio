...
public class VisualisRefExportService implements RefExportService {

    DevelopmentService developmentService;

    @Override
    public RefExportOperation createRefExportOperation() {
        VisualisRefExportOperation visualisRefExportOperation = new VisualisRefExportOperation(developmentService);
        return visualisRefExportOperation;
    }
