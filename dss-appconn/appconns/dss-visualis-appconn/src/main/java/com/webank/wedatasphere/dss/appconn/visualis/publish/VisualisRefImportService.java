...
public class VisualisRefImportService implements RefImportService {

    DevelopmentService developmentService;

    @Override
    public RefImportOperation createRefImportOperation() {
        VisualisRefImportOperation visualisRefImportOperation = new VisualisRefImportOperation(developmentService);
