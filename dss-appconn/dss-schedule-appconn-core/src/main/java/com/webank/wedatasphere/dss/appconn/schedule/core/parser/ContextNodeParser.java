...
public interface ContextNodeParser extends NodeParser {
    String[] getShareNodeIds(SchedulerNode node);
    void setReadNodeContext(SchedulerNode node);
    ReadNode parseNode(SchedulerNode node);
}
