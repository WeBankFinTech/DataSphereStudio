...
@RequestMapping(path = "/data-assets/asset", produces = {"application/json"})
@RestController
public class DSSDataGovernanceAssetRestful implements AuthenticationClientStrategy {
    ...
    @RequestMapping(value = "/getHiveDbsName",method = RequestMethod.GET)
    public Message getHiveDbsName(HttpServletRequest req,
                                  @RequestParam(value="limit",defaultValue = DEFAULT_LIMIT) int limit,
    @RequestParam(value="offset",defaultValue = DEFAULT_OFFSET)  int offset) throws Exception {
        return Message.ok().data("result", assetService.getHiveDbsName(limit,offset));
    }
    /**
     * 搜索hive表
     */
    ...
    public Message searchHiveTbl(@RequestParam(value = "classification",required = false) String classification,
    ...
    public Message modifyComment(@PathVariable("guid") String guid,@RequestParam("comment") String comment) throws Exception {
        comment = "\"" + comment + "\"";
