...
public class DataWarehouseGovernanceConfig {
    ...
    public static final CommonVars<Boolean> DISCOVERY_ENABLED = CommonVars.apply("wds.wedatasphere.warehouse.client.discovery.enabled", false);
    ...
    public static final CommonVars<String> AUTHENTICATION_STRATEGY = CommonVars.apply("wds.wedatasphere.warehouse.client.authenticationStrategy", "org.apache.linkis.httpclient.dws.authentication.StaticAuthenticationStrategy");
