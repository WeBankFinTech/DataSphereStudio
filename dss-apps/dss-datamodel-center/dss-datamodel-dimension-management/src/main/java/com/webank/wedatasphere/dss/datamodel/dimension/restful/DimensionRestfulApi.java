...
public class DimensionRestfulApi {
    ...
    public Message add(HttpServletRequest req, @RequestBody DimensionAddVO vo) throws ErrorException {
    ...
    public Message list(HttpServletRequest req,@RequestBody DimensionQueryVO vo){
