...
@RequestMapping(path = "/datamodel", produces = {"application/json"})
@RestController
public class IndicatorRestfulApi implements AuthenticationClientStrategy {
    ...
    public Message add(HttpServletRequest req, @RequestBody IndicatorAddVO vo) throws Exception {
    ...
    public Message addVersion(HttpServletRequest req, @PathVariable("id") Long id,@RequestBody IndicatorVersionAddVO vo) throws Exception {
    ...
    public Message versionRollBack(HttpServletRequest req,IndicatorVersionRollBackVO vo) throws Exception {
    ...
    public Message themesList(HttpServletRequest req){
        ...
        String jsonStr=governanceDwRemoteClient.execute(action).getResponseBody();
        JSONObject jsonObject=JSON.parseObject(jsonStr);
        JSONObject data=(JSONObject) jsonObject.get("data");
        return Message.ok().data("list",data.get("list"));
    }
