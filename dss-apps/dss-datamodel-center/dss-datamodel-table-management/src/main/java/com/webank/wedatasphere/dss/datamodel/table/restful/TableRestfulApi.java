...
//     public Message tableThemesList(HttpServletRequest req) {
...
//     public Message tableLayerList(HttpServletRequest req) {
...
//    }
    ...
    @RequestMapping(value = "/tables/partition/stats",method = RequestMethod.POST)
     public Message tblPartitionStats(HttpServletRequest req, TblPartitionStatsVO vo) {
        vo.setUser(getStrategyUser(req));
     ...
     * @throws IOException
     */
    @RequestMapping(value = "/labels/{id}",method = RequestMethod.POST)
