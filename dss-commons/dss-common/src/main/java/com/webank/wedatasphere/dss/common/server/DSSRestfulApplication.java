...
package com.webank.wedatasphere.dss.common.server;
...
public class DSSRestfulApplication extends ResourceConfig {

    private static final Log logger = LogFactory.getLog(DSSRestfulApplication.class);

    public DSSRestfulApplication() throws ClassNotFoundException {
