...
/**
 * @Classname DSSDataAPIAuthRestful @Description 服务管理--API授权 @Date 2021/7/14 10:44 @Created by suyc
 */
@RestController
@RequestMapping(
...
public class DSSDbApiAuthRestful {
    ...
    public Message saveApiAuth(@Context HttpServletRequest request, @RequestBody ApiAuth apiAuth)
    ...
    public Message getApiAuthList(
        ...
        List<ApiAuthInfo> apiAuths =
                apiAuthService.getApiAuthList(workspaceId, caller, totals, pageNow, pageSize);
