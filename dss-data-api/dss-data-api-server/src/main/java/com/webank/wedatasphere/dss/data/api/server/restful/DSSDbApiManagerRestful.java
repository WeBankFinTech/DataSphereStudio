...
/**
 * @author lenovo @Classname DSSDbApiManagerRestful @Description 服务管理--API管理 @Date 2021/7/19
 *     15:38 @Created by suyc
 */
@RestController
@RequestMapping(
...
public class DSSDbApiManagerRestful {
    ...
    public Message getApiList(
        ...
        List<ApiInfo> apiInfoList =
                apiManagerService.getApiInfoList(workspaceId, apiName, totals, pageNow, pageSize);
