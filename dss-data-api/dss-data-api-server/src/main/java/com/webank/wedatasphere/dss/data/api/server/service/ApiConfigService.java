...
public interface ApiConfigService extends IService<ApiConfig> {
    ...
    ApiExecuteInfo apiTest(
            String path, HttpServletRequest httpRequest, Map<String, Object> map, boolean isTest)
            throws Exception;

    ApiExecuteInfo apiExecute(String path, HttpServletRequest request, Map<String, Object> map)
            throws Exception;
}
