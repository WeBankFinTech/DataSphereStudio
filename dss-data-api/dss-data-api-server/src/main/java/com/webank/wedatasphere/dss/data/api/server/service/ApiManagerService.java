...
/** @Classname ApiManagerService @Description TODO @Date 2021/7/22 20:51 @Created by suyc */
public interface ApiManagerService {
    ...
    public List<ApiInfo> getApiInfoList(
            Long workspaceId, String apiName, List<Long> totals, Integer pageNow, Integer pageSize);
