...
/** @Classname ApiMonitorService @Description TODO @Date 2021/7/20 11:59 @Created by suyc */
public interface ApiMonitorService {
    ...
    List<HourMonitorInfo> getCallTimeForSinleApi(SingleCallMonitorRequest singleCallMonitorRequest)
            throws Exception;

    /** 时间范围内指定API的每小时的请求次数 */
    List<HourMonitorInfo> getCallCntForSinleApi(SingleCallMonitorRequest singleCallMonitorRequest)
            throws Exception;
}
