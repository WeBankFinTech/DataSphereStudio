...
/** @Classname DSSDataApiAuthServiceImpl @Description TODO @Date 2021/7/13 17:13 @Created by suyc */
@Service
@Slf4j
public class ApiAuthServiceImpl extends ServiceImpl<ApiAuthMapper, ApiAuth>
        implements ApiAuthService {
    @Autowired private ApiAuthMapper apiAuthMapper;
    ...
    @Override
    public List<ApiAuthInfo> getApiAuthList(
            Long workspaceId, String caller, List<Long> totals, Integer pageNow, Integer pageSize) {
