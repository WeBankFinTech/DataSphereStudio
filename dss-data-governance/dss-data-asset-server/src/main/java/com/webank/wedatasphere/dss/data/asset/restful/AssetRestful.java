...
/** @author suyc @Classname AssetRestful @Description TODO @Date 2021/8/19 13:53 @Created by suyc */
@RestController
@RequestMapping(
...
public class AssetRestful {
    ...
    public Message modifyComment(@PathVariable String guid, @RequestParam String comment)
            throws Exception {
        comment = "\"" + comment + "\"";
    ...
    public Message setLabels(
            @PathVariable String guid, @RequestBody HiveTblLabelInfo hiveTblLabelInfo)
            throws Exception {
    ...
    public Message getWorkspaceUsers(@PathVariable int workspaceId, @PathVariable String search)
            throws Exception {
