...
/** @Author: chaogefeng @Date: 2020/3/9 */
@Service
public class WorkspaceInfoServiceImpl implements WorkspaceInfoService {

    @Autowired private WorkspaceInfoMapper workspaceInfoMapper;

    @Override
    public List<String> getWorkspaceUsers(int workspaceId, String search)
            throws DataGovernanceException {

        List<String> workspaceUsers =
                workspaceInfoMapper.getWorkspaceUsersName(workspaceId, search);
