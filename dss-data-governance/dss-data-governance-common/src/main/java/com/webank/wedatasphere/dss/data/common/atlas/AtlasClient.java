...
/** @author suyc @Classname AtlasClient @Description TODO @Date 2021/8/19 14:17 @Created by suyc */
public class AtlasClient extends AtlasClientV2 {
    ...
    private static final String DELETE_ENTITY_LABELS_BY_GUID_TEMPLATE =
            ENTITY_API + "/guid/%s/labels";
    private static final String GET_ENTITY_HEADER_BY_GUID_TEMPLATE =
            ENTITY_API + "/guid/{guid}/header";
    ...
    private static final String GET_CLASSIFICATION_BY_NAME_TEMPLATE =
            TYPES_API + "classificationdef/name/%s";
    ...
    /** 获取表实体的血缘信息 */
    public String getLineageInfoForString(
    ...
    /** 获取实体信息 */
    public String getEntityByGuidForString(
            String guid, boolean minExtInfo, boolean ignoreRelationships)
            throws AtlasServiceException {
        MultivaluedMap<String, String> queryParams = new MultivaluedMapImpl();
    ...
    public String getEntityByAttributeForString(
            String type,
    ...
    public String getEntitiesByGuidsForString(
    ...
    public String getHeaderByIdForString(String guid) throws AtlasServiceException {
        API api =
                new API(
                        String.format(GET_ENTITY_HEADER_BY_GUID_TEMPLATE, guid),
                        HttpMethod.GET,
                        Response.Status.OK);
    ...
    /** 根据关键字检索实体 */
    public String basicSearchForString(
    ...
    public void setLabels(String guid, Set<String> labels) throws AtlasServiceException {
        API api =
                new API(
                        String.format(SET_ENTITY_LABELS_BY_GUID_TEMPLATE, guid),
                        HttpMethod.POST,
    ...
    public void removeLabels(String guid, Set<String> labels) throws AtlasServiceException {
        API api =
                new API(
                        String.format(DELETE_ENTITY_LABELS_BY_GUID_TEMPLATE, guid),
                        HttpMethod.DELETE,
                        Response.Status.NO_CONTENT);
        callAPI(api, (Class<?>) null, labels);
    }
    ...
    public String getClassificationDefByNameForString(String name) throws AtlasServiceException {
        API api =
                new API(
                        String.format(GET_CLASSIFICATION_BY_NAME_TEMPLATE, name),
                        HttpMethod.GET,
                        Response.Status.OK);
        return callAPI(api, String.class, null);
    }
    ...
    /** 创建类型 */
    public String createAtlasTypeDefsForString(final AtlasTypesDef typesDef)
            throws AtlasServiceException {
    ...
    public void addClassifications(String guid, List<AtlasClassification> classifications)
        ...
        callAPI(
                ...
                (Class<?>) null,
                AtlasType.toJson(classifications),
                (String[]) null);
    }
    ...
    public static class API_V3 extends API {
        public static final API_V3 GET_ENTITIES =
                new API_V3(ENTITIES_API, HttpMethod.GET, Response.Status.OK);
        public static final API_V3 UPDATE_ENTITY_ATTR =
                new API_V3(UPDATE_ENTITY_ATTR_API, HttpMethod.PUT, Response.Status.OK);
        public static final API_V3 DELETE_TYPEDEF_BY_NAME =
                new API_V3(TYPEDEF_BY_NAME, HttpMethod.DELETE, Response.Status.NO_CONTENT);
