...
/**
 * @author suyc @Classname AtlasServiceImpl @Description TODO @Date 2021/8/20 9:21 @Created by suyc
 */
...
public class AtlasService {
    ...
    public AtlasService() {
        ...
        String[] basicAuthUsernamePassword =
                new String[] {
                    AtlasConf.ATLAS_USERNAME.getValue(), AtlasConf.ATLAS_PASSWORD.getValue()
                };
    ...
    /** 根据关键字搜索hive table */
    public List<AtlasEntityHeader> searchHiveTable(
        ...
        String jsonStr =
                atlasClient.basicSearchForString(
                        "hive_table", classification, query, excludeDeletedEntities, limit, offset);
    ...
    public AtlasEntity getHiveTblByGuid(String guid) throws AtlasServiceException {
        ...
        AtlasEntity.AtlasEntityWithExtInfo atlasEntityWithExtInfo =
                gson.fromJson(jsonStr, AtlasEntity.AtlasEntityWithExtInfo.class);

        return atlasEntityWithExtInfo.getEntity();
    }

    /** 获取hive table对象 */
    public AtlasEntity getHiveTblByAttribute(
            Map<String, String> uniqAttributes, boolean minExtInfo, boolean ignoreRelationship)
            throws AtlasServiceException {
        String jsonStr =
                atlasClient.getEntityByAttributeForString(
                        "hive_table", uniqAttributes, minExtInfo, ignoreRelationship);
    ...
    /** 获取多个hive column对象 */
    public List<AtlasEntity> getHiveColumnsByGuids(List<String> guids)
            throws AtlasServiceException {
        ...
        AtlasEntity.AtlasEntitiesWithExtInfo atlasEntitiesWithExtInfo =
                gson.fromJson(jsonStr, AtlasEntity.AtlasEntitiesWithExtInfo.class);
    ...
    public Map<String, Object> getHiveTblAttributesByGuid(String guid)
            throws AtlasServiceException {
        ...
        result.put(
                "isPartition",
                ((List) atlasEntityWithExtInfo.getEntity().getAttribute("partitionKeys")).size()
                        > 0);
        result.put("tableType", atlasEntityWithExtInfo.getEntity().getAttribute("tableType"));
        Map<String, Object> sdMap =
                (LinkedTreeMap) atlasEntityWithExtInfo.getEntity().getRelationshipAttribute("sd");
        if (null != sdMap) {
            result.put(
                    "location",
                    atlasEntityWithExtInfo
    ...
    public AtlasClassificationDef getClassificationDefByName(String name)
        ...
        AtlasClassificationDef atlasClassificationDef =
                gson.fromJson(jsonStr, AtlasClassificationDef.class);

        return atlasClassificationDef;
    }

    /** 根据名称获取分类的一级子类型 */
    public List<AtlasClassificationDef> getClassificationDefListByName(String name)
            throws AtlasServiceException {
        List<AtlasClassificationDef> atlasClassificationDefList =
                new ArrayList<AtlasClassificationDef>();
    ...
    public List<AtlasClassificationDef> getClassificationDefListForLayer()
            throws AtlasServiceException {
        List<AtlasClassificationDef> atlasClassificationDefList =
                new ArrayList<AtlasClassificationDef>();
        // 系统预置分层的一级子分类
        atlasClassificationDefList.addAll(
                this.getClassificationDefListByName(
                        AtlasConf.ATLAS_CLASSIFICATION_LAYER_SYSTEM.getValue()));

        // 用户自定义分层的一级子分类
        atlasClassificationDefList.addAll(
                this.getClassificationDefListByName(
                        AtlasConf.ATLAS_CLASSIFICATION_LAYER_USER.getValue()));
    ...
    public void removeAndAddClassifications(
            ...
            throws AtlasServiceException {
        AtlasClassificationV2.AtlasClassificationsV2 oldAtlasClassifications =
                this.getClassifications(guid);
    ...
    public AtlasClassificationV2.AtlasClassificationsV2 getClassifications(String guid)
        ...
        // org.codehaus.jackson.map.JsonMappingException: Conflicting getter definitions for
        // property "propagate"
        AtlasClassificationV2.AtlasClassificationsV2 atlasClassifications =
                gson.fromJson(jsonStr, AtlasClassificationV2.AtlasClassificationsV2.class);
