...
public final class HttpClientUtil {
    ...
    public static String invokeGet(
            String url,
        ...
        try {
            ...
            logger.error(
                    String.format("[HttpUtils Get]invoke get error, url:%s", sb.toString()), e);
        } finally {
    ...
    public static String connectPostHttps(String reqURL, Map<String, String> params) {
        ...
        try {
            ...
            logger.info(
                    "requestURI : " + httpPost.getURI() + ", responseContent: " + responseContent);
     ...
     * @author: XIEJIAN948@pingan.com.cn
     */
    public static String postJsonBody2(
            String url,
            int timeout,
            Map<String, Object> headerMap,
            List<NameValuePair> paramsList,
     ...
     * @author: XIEJIAN948@pingan.com.cn
     */
    public static String postJsonBody3(
            String url,
            int timeout,
            Map<String, Object> headerMap,
        ...
        try {
            ...
            if (paramsList.size() > 0) {
                ...
                // logger.info("successfully  start post Json Body  url{},params ",
