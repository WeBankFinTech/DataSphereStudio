 ...
 */
@Service
public class DssAdminDeptServiceImpl extends ServiceImpl<DssAdminDeptMapper, DssAdminDept>
        implements DssAdminDeptService {
    @Resource private DssAdminDeptMapper dssAdminDeptMapper;
    ...
    public String checkDeptNameUnique(DssAdminDept dssAdminDept) {
        ...
        DssAdminDept info =
                dssAdminDeptMapper.checkDeptNameUnique(
                        dssAdminDept.getDeptName(), dssAdminDept.getParentId());
