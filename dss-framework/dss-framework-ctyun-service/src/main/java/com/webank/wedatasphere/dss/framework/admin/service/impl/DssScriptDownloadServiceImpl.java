...
/** @Auther: Han Tang @Date: 2022/1/11-01-11-15:29 */
@Service
public class DssScriptDownloadServiceImpl
        extends ServiceImpl<DssAuditMapper, DssScriptDownloadAudit>
        implements DssScriptDownloadService {
    @Autowired public DssAuditMapper dssAuditMapper;

    public List<DssScriptDownloadAudit> getDownloadAuditList(
