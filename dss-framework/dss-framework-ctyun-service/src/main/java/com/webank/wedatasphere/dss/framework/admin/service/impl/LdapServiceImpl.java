...
//        ldapService.addUserWithPwd("cn=Manager,dc=example,dc=com", "hantang", "ldap://xxxxx:389", "dc=example,dc=com", "ht010023", "Th34082519861!","ht010014");
        ldapService.updatePwd("cn=Manager,dc=example,dc=com", "hantang", "ldap://hadoop02:389", "dc=example,dc=com", "ht010023", "Th34082519861!");

//        ldapService.addUser("cn=Manager,dc=example,dc=com", "hantang", "ldap://hadoop02:389", "ou=user,dc=example,dc=com", "ht01001", "Th34082519861!");
//        ldapService.update("cn=Manager,dc=example,dc=com", "Aaht123@chinanet", "ldap://1xxxx:389", "ou=user,dc=example,dc=com", "ht02", "1Th34082519861!");
//        boolean exist = ldapService.exist("cn=Manager,dc=example,dc=com", "Aaht123@chinanet", "ldap://xxxxx:389", "ou=user,dc=example,dc=com", "ht03");
//        System.out.println("===" + exist);
//        int  id = ldapService.getMaxId("cn=Manager,dc=example,dc=com", "hantang", "ldap://hadoop02:389", "ou=user,dc=example,dc=com","user");
    }
