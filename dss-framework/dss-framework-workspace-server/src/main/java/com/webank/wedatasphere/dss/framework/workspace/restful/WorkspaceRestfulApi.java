...
public class WorkspaceRestfulApi {
    ...
    public Message getUsernameExistence(
            HttpServletRequest req, @RequestParam(required = false, name = "name") String name) {
    ...
    public Message addWorkspace(HttpServletRequest req, @RequestBody Map<String, String> json)
        ...
        int workspaceId =
                dssWorkspaceService.createWorkspace(
                        name, label, userName, description, department, productName, workspaceType);
    ...
    public Message getWorkspaceManagements(
            HttpServletRequest req, @PathVariable("workspaceId") Long workspaceId) {
        String header = req.getHeader("Content-language").trim();
        boolean isChinese = "zh-CN".equals(header);
        String username = SecurityFilter.getLoginUsername(req);
        List<OnestopMenuVo> managements =
                dssWorkspaceService.getWorkspaceManagements(workspaceId, username, isChinese);
    ...
    public Message getWorkspaceApplications(
            HttpServletRequest req, @PathVariable("workspaceId") Long workspaceId) {
        String header = req.getHeader("Content-language").trim();
        boolean isChinese = "zh-CN".equals(header);
        String username = SecurityFilter.getLoginUsername(req);
        List<OnestopMenuVo> applications =
                dssWorkspaceService.getWorkspaceApplications(workspaceId, username, isChinese);
    ...
    public Message getWorkspaceFavorites(
        ...
        boolean isChinese = "zh-CN".equals(header);
        String username = SecurityFilter.getLoginUsername(req);
        List<WorkspaceFavoriteVo> favorites =
                dssWorkspaceService.getWorkspaceFavorites(
                        workspaceId, username, isChinese, type == null ? "" : type);
    ...
    public Message getWorkspaceComponent(
            HttpServletRequest req,
            @PathVariable("workspaceId") Long workspaceId,
            @RequestParam(value = "type", required = false) String type) {
        String header = req.getHeader("Content-language").trim();
    ...
    public Message addFavorite(
        ...
        Long favoriteId =
                dssWorkspaceService.addFavorite(username, workspaceId, menuApplicationId, type);
    ...
    public Message deleteFavorite(
        ...
        String type = json.get("type") == null ? "" : json.get("type");
        Long favoriteId =
                dssWorkspaceService.deleteFavorite(username, applicationId, workspaceId, type);
        return Message.ok().data("favoriteId", favoriteId);
    }
    ...
    public Message deleteFavorite1(
            HttpServletRequest req,
            @PathVariable("workspaceId") Long workspaceId,
            @PathVariable("applicationId") Long applicationId,
            @RequestParam(value = "type", required = false) String type) {
    ...
    public Message deleteFavorite2(
            HttpServletRequest req,
            @PathVariable("workspaceId") Long workspaceId,
            @PathVariable("favouritesId") Long favouritesId,
            @RequestParam(value = "type", required = false) String type) {
        String username = SecurityFilter.getLoginUsername(req);
        Long favoriteId =
                dssWorkspaceService.deleteFavorite(username, favouritesId, workspaceId, type);
        return Message.ok().data("favoriteId", favoriteId);
    }
}
