...
public class WorkspaceDBHelper {
    ...
    public List<DSSWorkspaceHomepage> generateDefaultWorkspaceHomepage(int workspaceId, String username){
        ...
        dssWorkspaceHomepages.add(new DSSWorkspaceHomepage(workspaceId, 2, analyserUrl, date));
        dssWorkspaceHomepages.add(new DSSWorkspaceHomepage(workspaceId, 3, analyserUrl, date));
