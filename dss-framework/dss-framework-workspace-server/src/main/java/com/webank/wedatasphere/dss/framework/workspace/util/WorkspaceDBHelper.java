...
/**
 * created by cooperyang on 2020/3/17 Description:一个数据库的helper类，这个类可以将一些数据load到内存，比如menu信息，role的信息等
 */
@Component
public class WorkspaceDBHelper {
                ...
                .scheduleAtFixedRate(
                        new Runnable() {
                            ...
                            public void run() {
                                synchronized (lock) {
                                    dssApplicationBeans =
                                            dssWorkspaceRoleMapper.getDSSApplications();
                                }
                            }
                        },
                        0,
                                                                    ...
                                                                    "workflow"
                                                                            .equals(
                                                                                    dssApplicationBean
                                                                                            ...
                                                                                            .toLowerCase()))
                                                    .findFirst()
                                                    .map(DSSApplicationBean::getHomepageUrl)
                                                    .orElse(defaultUrl);
                                    String analyserUrl =
                                            dssApplicationBeans.stream()
                                                    .filter(
    ...
    public List<DSSWorkspaceMenuRole> generateDefaultWorkspaceMenuRole(
    ...
    public List<DSSWorkspaceHomepage> generateDefaultWorkspaceHomepage(
            int workspaceId, String username) {
        String defaultUrl = "/workspace";
        String maintenanceUrl = "/workspaceHome/scheduleCenter";
        String developerUrl =
                dssApplicationBeans.stream()
                        .filter(
                                dssApplicationBean ->
                                        "workflow"
                                                .equals(dssApplicationBean.getName().toLowerCase()))
                        .findFirst()
                        .map(DSSApplicationBean::getHomepageUrl)
                        .orElse(defaultUrl);
        String analyserUrl =
                dssApplicationBeans.stream()
                        .filter(
                                dssApplicationBean ->
                                        "linkis".equals(dssApplicationBean.getName().toLowerCase()))
                        .findFirst()
                        .map(DSSApplicationBean::getHomepageUrl)
                        .orElse(defaultUrl);
    ...
    public List<DSSWorkspaceComponentPriv> generateDefaultWorkspaceComponentPrivs(
            int workspaceId, String username) {
        List<DSSWorkspaceComponentPriv> dssWorkspaceComponentPrivs = new ArrayList<>();
        Date updateTime = new Date(System.currentTimeMillis());

        // 管理员
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 1, 1, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 1, 2, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 1, 3, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 1, 4, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 1, 5, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 1, 6, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 1, 7, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 1, 8, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 1, 9, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 1, 10, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 1, 11, 1, updateTime, username));
        // 运维

        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 2, 1, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 2, 2, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 2, 3, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 2, 4, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 2, 5, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 2, 6, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 2, 7, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 2, 8, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 2, 9, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 2, 10, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 2, 11, 0, updateTime, username));

        // 开发
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 3, 1, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 3, 2, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 3, 3, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 3, 4, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 3, 5, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 3, 6, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 3, 7, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 3, 8, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 3, 9, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 3, 10, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 3, 11, 0, updateTime, username));

        // 分析
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 4, 1, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 4, 2, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 4, 3, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 4, 4, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 4, 5, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 4, 6, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 4, 7, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 4, 8, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 4, 9, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 4, 10, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 4, 11, 0, updateTime, username));
        // 运营
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 5, 1, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 5, 2, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 5, 3, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 5, 4, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 5, 5, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 5, 6, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 5, 7, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 5, 8, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 5, 9, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 5, 10, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 5, 11, 0, updateTime, username));

        // 数据服务
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 6, 1, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 6, 2, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 6, 3, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 6, 4, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 6, 5, 1, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 6, 6, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 6, 7, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 6, 8, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 6, 9, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 6, 10, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 6, 11, 0, updateTime, username));
        // 访客
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 7, 1, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 7, 2, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 7, 3, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 7, 4, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 7, 5, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 7, 6, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 7, 7, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 7, 8, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 5, 9, 0, updateTime, username));
        dssWorkspaceComponentPrivs.add(
                new DSSWorkspaceComponentPriv(workspaceId, 5, 10, 0, updateTime, username));
    ...
    public List<DSSRole> getRoles(int workspaceId) {
        return this.dssRoles.stream()
                .filter(
                        dssRole ->
                                dssRole.getWorkspaceId() == workspaceId
                                        || dssRole.getWorkspaceId() == -1)
                .collect(Collectors.toList());
    }

    public List<String> getComponentUrlsById(int componentId) {
        Optional<DSSWorkspaceMenuComponentUrl> optional =
                dssWorkspaceMenuComponentUrls.stream()
                        .filter(obj -> obj.getMenuId() == componentId)
                        .findFirst();
    ...
    public String getRoleFrontName(int roleId) {
        DSSRole role =
                dssRoles.stream()
                        .filter(dssRole -> dssRole.getId() == roleId)
                        .findFirst()
                        .orElse(null);
        if (role != null) {
    ...
    public List<DSSWorkspaceRoleVO> getRoleVOs(int workspaceId) {
        return getRoles(workspaceId).stream()
                .map(this::changeToRoleVO)
                .collect(Collectors.toList());
    }
    ...
    public DSSOnestopMenu getMenuNameById(int menuId) {
        if (dssOnestopMenus.stream().anyMatch(dssMenu -> dssMenu.getId() == menuId)) {
            return dssOnestopMenus.stream()
                    .filter(dssMenu -> dssMenu.getId() == menuId)
                    .findFirst()
                    .get();
        } else {
            return null;
    ...
    public List<Integer> getAllComponentIds() {
        return dssWorkspaceComponents.stream()
                .map(DSSWorkspaceComponent::getId)
                .collect(Collectors.toList());
    }
}
