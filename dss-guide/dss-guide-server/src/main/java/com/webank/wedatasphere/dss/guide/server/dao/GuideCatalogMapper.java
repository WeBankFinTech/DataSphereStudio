...
/**
 * @author suyc @Classname GuideCatalogMapper @Description TODO @Date 2022/1/13 20:30 @Created by
 *     suyc
 */
@Mapper
public interface GuideCatalogMapper extends BaseMapper<GuideCatalog> {
    ...
    @Select(
            "SELECT * FROM dss_guide_catalog WHERE is_delete =0 AND parent_id =#{id} ORDER BY id ASC")
