...
/**
 * @author suyc @Classname GuideQueryRestful @Description TODO @Date 2021/12/24 10:04 @Created by
 *     suyc
 */
@RestController
@RequestMapping(
        path = "/dss/guide/query",
...
public class GuideQueryRestful {
    ...
    public Message queryGuideChapter(
        ...
        List<GuideChapter> guideChapterList =
                guideChapterService.searchGuideChapterList(keyword, totals, pageNow, pageSize);
