...
package com.webank.wedatasphere.dss.flow.execution.entrance.listener
...
/**
  ...
  */
trait NodeRunnerListener {

  def onStatusChanged(fromState: NodeExecutionState, toState: NodeExecutionState, node: SchedulerNode): Unit
}
