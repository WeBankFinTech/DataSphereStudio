...
public interface DSSFlowService {
    ...
    DSSFlow addSubFlow(DSSFlow DSSFlow, Long parentFlowID, String contextIDStr)
    ...
    //    DWSFlowVersion getLatestVersionByFlowIDAndProjectVersionID(Long flowID, Long
    // projectVersionID);
    ...
    //
    //    void flowVersionIncr(Long flowID, String userName, String comment, Long
    // newProjectVersionID, Long oldProjectVersionID,
