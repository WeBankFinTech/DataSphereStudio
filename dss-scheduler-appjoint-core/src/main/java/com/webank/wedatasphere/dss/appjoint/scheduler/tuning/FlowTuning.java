 ...
 */
public interface FlowTuning extends Order {
    SchedulerFlow tuningSchedulerFlow(SchedulerFlow schedulerFlow);
    void setNodeTunings(NodeTuning[] NodeTunings);
    NodeTuning[] getNodeTunings();
    Boolean ifFlowCanTuning(SchedulerFlow schedulerFlow);
}
