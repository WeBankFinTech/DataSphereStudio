...
public interface ProjectServiceFlowFunction {
    void accept(ProjectService projectService, Project project, Flow flow, Session session) throws AppJointErrorException;
}
