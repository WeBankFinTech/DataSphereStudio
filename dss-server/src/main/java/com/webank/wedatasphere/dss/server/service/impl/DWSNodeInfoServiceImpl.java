...
import com.webank.wedatasphere.dss.server.dao.NodeInfoMapper;
...
@Service
public class DWSNodeInfoServiceImpl implements DWSNodeInfoService {

    @Autowired
    private NodeInfoMapper nodeInfoMapper;

    @Override
    public List<NodeInfo> getNodeType(String developProject) {
        return nodeInfoMapper.selectNodeInfo(developProject);
    }
