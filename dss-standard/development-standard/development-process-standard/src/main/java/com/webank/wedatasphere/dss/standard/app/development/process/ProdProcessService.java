...
public class ProdProcessService extends AbstractProcessService {


    public ProdProcessService(List<RefOperationService> refOperationServices) {
    ...
    public RefImportService getRefImportService(){
        return (RefImportService) findRefOperationService(RefImportService.class);
    }
