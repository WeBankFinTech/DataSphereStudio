...
public interface RefPublishToSchedulerService extends RefOperationService {

    RefScheduleOperation createRefScheduleOperation();
    OperationalRefScheduleOperation createOperationalRefScheduleOperation(RequestRef requestRef);
}
