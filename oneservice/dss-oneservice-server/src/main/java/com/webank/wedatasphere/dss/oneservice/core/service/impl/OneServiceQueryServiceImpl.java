...
import com.webank.wedatasphere.dss.oneservice.core.constant.ParamTypeEnum;
import com.webank.wedatasphere.dss.oneservice.core.constant.RequireEnum;
import com.webank.wedatasphere.dss.oneservice.core.constant.StatusEnum;
...
import com.webank.wedatasphere.dss.oneservice.core.jdbc.DatasourceService;
import com.webank.wedatasphere.dss.oneservice.core.jdbc.JdbcUtil;
import com.webank.wedatasphere.dss.oneservice.core.restful.exception.OneserviceRuntimeException;
import com.webank.wedatasphere.dss.oneservice.core.service.OneServiceQueryService;
import com.webank.wedatasphere.dss.oneservice.core.util.AssertUtil;
import com.webank.wedatasphere.dss.oneservice.core.util.DateUtil;
import com.webank.wedatasphere.dss.oneservice.core.util.ModelMapperUtil;
...
import com.webank.wedatasphere.dss.oneservice.core.vo.ParamType;
...
public class OneServiceQueryServiceImpl implements OneServiceQueryService {
    ...
    public List<TestParamVo> query(String scriptPath, String version) {
        OneServiceVo oneServiceVo = oneServiceConfigDao.queryByScriptPathVersion(scriptPath, version);

        AssertUtil.notNull(oneServiceVo, "接口不存在，path=" + scriptPath);
    ...
    public List<ApiVersionVo> queryApiVersion(String scriptPath) {
        ...
        OneServiceVo oneServiceVo = oneServiceConfigDao.queryByScriptPath(scriptPath);
