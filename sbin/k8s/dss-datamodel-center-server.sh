...
SERVER_SUFFIX="dss-datamodel-center-server"
...
export SERVER_JAVA_OPTS="-DserviceName=$SERVER_SUFFIX -Xmx512M -XX:+UseG1GC -Xloggc:$SERVER_LOG_PATH/linkis.log"

export SERVER_CLASS=com.webank.wedatasphere.dss.datamodel.DataModelApplication
