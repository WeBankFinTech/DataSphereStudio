...
<script>
import { getThemesList } from "../../service/api/common";
import { getMeasures } from "../../service/api/measures";
import { getIndicators } from "../../service/api/indicators";
import { getDimensions } from "../../service/api/dimensions";
export default {
  model: {
    prop: "_visible",
