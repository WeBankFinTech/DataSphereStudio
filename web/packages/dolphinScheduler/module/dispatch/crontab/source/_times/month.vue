        ...
        <Radio-group v-model="radioMonth" vertical size="small">
          ...
          <div class="list-box">
            <Radio label="cycleMonth" size="small">
              ...
              <span class="text" style="margin-left: 46px;">{{$t2('月')}}</span>
            </Radio>
          </div>
        </Radio-group>
      </template>
