  ...
  <div class="information-box">
    <div
      ...
      <div class="information-text">
        ...
        <label>{{$t('message.workspaceManagement.productsetting.adminviewall')}}<span>{{workspaceData.view_permission ? $t('message.workspaceManagement.productsetting.yes') : $t('message.workspaceManagement.productsetting.no')}}</span></label>
      </div>
    </div>
