...
export default {
  ...
  //         name: '数据资产',
  //         children: [
  //           { id: 11, name: '数据总览', pathName: 'dataAssetManage/overview' },
  //           { id: 12, name: '数据资产目录', pathName: 'dataAssetManage/assets' },
  //         ],
  //       },
  //       {
  //         id: 2,
  ...
  // computed: {
  //   searchScroll() {
  //     return this.$route.name === 'dataAssetManage/assets/search'
  //   },
  // },
  // mounted() {
  //   let pathName = this.$route.name
  //   if (pathName !== 'dataAssetManage/overview') {
  //     sessionStorage.removeItem('searchTbls')
  //     const workspaceId = this.$route.query.workspaceId
  //     this.$router.push({
  //       name: 'dataAssetManage/overview',
  //       query: { workspaceId },
  //     })
  //   }
  // },
...
<style lang="scss" src="@/apps/dataAssetManage/assets/styles/console.scss"></style>
