...
import log from '@/apps/scriptis/service/db/log.js';
import history from '@/apps/scriptis/service/db/history.js';
import result from '@/apps/scriptis/service/db/result.js';
import globalcache from '@/apps/scriptis/service/db/globalcache.js';
import progress from '@/apps/scriptis/service/db/progress.js';
