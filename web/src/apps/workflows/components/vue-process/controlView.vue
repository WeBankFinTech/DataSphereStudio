...
<template>
  <div class="designer-control">
    ...
    <div class="designer-control-buttons">
      ...
      <div v-show="!state.mapMode" class="designer-control-button" :title="$t('message.workflow.vueProcess.format')" @click="formatDialogVisible = !formatDialogVisible; confirmResetDialogVisible = false">
        <Icon name="geshishua" />
      </div>
      <div v-show="state.isFormatted  && !state.mapMode" class="designer-control-button" :title="$t('message.workflow.vueProcess.returnFormat')" @click="confirmResetDialogVisible = !confirmResetDialogVisible; formatDialogVisible = false">
