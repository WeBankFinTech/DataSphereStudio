<template>
  <div class="month-model">
    <div class="v-crontab-form-model">
      <template>
        <Radio-group v-model="radioMonth" vertical size="small">
          <div class="list-box">
            <Radio label="everyMonth" size="small">
              <span class="text">{{$t2('每一月')}}</span>
            </Radio>
          </div>
          <div class="list-box">
            <Radio label="intervalMonth" size="small">
          ...
          <div class="list-box">
            <Radio label="cycleMonth" size="small">
              ...
              <span class="text" style="margin-left: 65px;">{{$t2('月')}}</span>
            </Radio>
          </div>
        </Radio-group>
      </template>
