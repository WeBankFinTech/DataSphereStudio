<template>
  <div class="day-model">
    <div class="v-crontab-form-model">
      <template>
        <Radio-group v-model="radioDay" vertical size="small">
          <div class="list-box">
            <Radio label="everyDay">
              <span class="text">{{$t2('每一天')}}</span>
            </Radio>
          </div>
          <div class="list-box">
          ...
          <div class="list-box">
            <Radio label="monthLastDays" size="small">
              <span class="text">{{$t2('在这个月的最后一天')}}</span>
            </Radio>
          </div>
          <div class="list-box">
            <Radio label="monthLastWorkingDays" size="small">
              <span class="text">{{$t2('在这个月的最后一个工作日')}}</span>
            </Radio>
          </div>
          <div class="list-box">
