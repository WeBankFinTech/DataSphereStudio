        ...
        <Radio-group v-model="radioMinute" vertical size="small">
          ...
          <div class="list-box">
            <Radio label="cycleMinute" size="small">
              ...
              <span class="text" style="margin-left: 65px;">{{$t2('分')}}</span>
            </Radio>
          </div>
        </Radio-group>
      </template>
