...
export const guideConfig = {
  ...
  "/workspaceManagement": {
    title: '了解工作空间管理',
    desc: '工作空间管理页，是工作空间【管理员】进行工作空间人员管理，角色分配的页面，其可以在本页面查看工作空间信息，导入、删除工作空间成员，以及配置成员角色，配置角色权限策略等',
    steps: [
      {
        seq: '第一步',
        title: '新增用户，配置角色',
  ...
  "/console": {
    title: '了解管理台',
    desc: '管理台，是工作空间的全局配置中心，【管理员】可以对于整个工作空间进行资源管控，全局历史查看，组件参数配置，全局变量设置等操作。',
    steps: [
      {
        seq: '第一步',
        title: '查看全局历史',
