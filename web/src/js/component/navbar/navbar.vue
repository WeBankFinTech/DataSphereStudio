  ...
  <div class="we-file-navbar">
    ...
    <div
      ...
      <Icon
        ...
        :title="$t('message.navBar.dataStudio.outTable')"
        class="navbar-cursor"
        @click="exportFrom"/>
      <Icon
        ...
        :title="$t('message.navBar.dataStudio.importHive')"
        class="navbar-cursor"
        @click="importTo"/>
      <Icon
      ...
      <Icon
        ...
        :size="20"
        type="ios-refresh"
        :title="$t('message.constants.refresh')"
        class="navbar-cursor"
        @click="refresh"/>
    </div>
  </div>
...
export default {
  ...
  props: {
    ...
    placeholder: {
      ...
      default () {
        // 这里不能写成箭头函数 要拿到this值
        return this.$t('message.navBar.dataStudio.searchPlaceholder')
      }
    },
    addTitle: {
      type: String,
      default () {
        return this.$t('message.navBar.dataStudio.addTitle')
      }
    },
  },
  data() {
