...
function translateReq(text, cb) {
  http.get(`${url}${encodeURIComponent(text)}`, {
    headers: {
      ...
      'cookie': 'OUTFOX_SEARCH_USER_ID=-1618593213@127.0.0.1; OUTFOX_SEARCH_USER_ID_NCOO=1383392327.7494588; _ga=GA1.2.1485522253.1539140851; P_INFO=***REMOVED***|1545711281|1|youdaonote|00&99|null&null&null#gud&440300#10#0|&0||***REMOVED***; SESSION_FROM_COOKIE=www.baidu.com',
